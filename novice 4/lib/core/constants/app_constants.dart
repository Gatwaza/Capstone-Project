...
class AppConstants {
  ...
  static const Map<String, String> promptsEn = {
    ...
    'too_shallow_severe':'Much too shallow. Push hard, five to six centimeters.',
    'too_deep':         'Ease off slightly — five to six centimeters is enough.',
    'too_deep_severe':  'Way too deep. Ease off — five to six centimeters is enough.',
    'rate_too_slow':    'Faster. Push to the beat.',
    'rate_too_slow_severe':'Way too slow. Push hard and fast, now.',
    'rate_too_fast':    'Ease back, you\'re rushing it.',
    'rate_too_fast_severe':'Way too fast. Slow right down.',
  ...
  static const Map<String, String> promptsRw = {
    ...
    'too_shallow_severe':'Kanda cyane cyane. Santimetero eshanu kugeza esheshatu.',
    'too_deep':         'Fata neza. Kuri santimetero eshanu kugeza cyenda.',
    'too_deep_severe':  'Urakanda cyane. Fata neza — santimetero eshanu kugeza esheshatu.',
    'rate_too_slow':    'Yihutirire. Komeza intera.',
    'rate_too_slow_severe':'Yihuta cyane. Kanda vuba kandi ukomeze.',
    'rate_too_fast':    'Yigende buhoro gato.',
    'rate_too_fast_severe':'Ugenda cyane. Gabanya umuvuduko byihuse.',
